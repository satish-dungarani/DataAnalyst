...
namespace DataAnalystDB
{
    ...
    public partial class SupplierMas
    {
        public SupplierMas()
        {
            this.CustSuppAssociation = new HashSet<CustSuppAssociation>();
        ...
        public virtual ICollection<CustSuppAssociation> CustSuppAssociation { get; set; }
